...
namespace Strings
{
    ...
    namespace impl::Format
    {
        ...
        // Provides storage for format strings generated by `STR(...)`.
        // This is used in `FORMAT_impl_inline_str`.
        // We can't create a static variable directly in the macro (in the lambda), because it stops the lambda from being constexpr.
        template <typename Lambda>
        inline constexpr auto format_string_storage = Lambda{}();
    }
}
