...
namespace Math
{
    ...
    namespace Export
    {
        using Vector::vec; // We use this instead of `using namespace Vector` to avoid bringing the overloaded operators ...
        using Vector::mat; // ... into the global namespace, mostly for better error messages and build speed.
